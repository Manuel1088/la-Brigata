...
export default function SalePage() {
  ...
  // form nuovo
  const [form, setForm] = useState<BookingArea>({ id: '', name: '', type: 'sala', openTime: '11:00', closeTime: '23:00', seatingsPerService: 1 })
  ...
  const addArea = () => {
    ...
    const next: BookingArea[] = [
      ...areas,
      {
        ...
        type: form.type || 'sala',
        quantity: 1,
        openTime: form.openTime || '11:00',
        closeTime: form.closeTime || '23:00',
        seatingsPerService: Math.max(1, Number(form.seatingsPerService || 1)),
      }
    ]
    saveAreas(next)
    setForm({ id: '', name: '', type: 'sala', openTime: '11:00', closeTime: '23:00', seatingsPerService: 1 })
  }
  ...
  const saveEdit = (id: string) => {
    ...
    const next = areas.map(a => a.id === id ? {
      ...
      openTime: payload.openTime || '11:00',
      closeTime: payload.closeTime || '23:00',
